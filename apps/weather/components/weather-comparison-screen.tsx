...
import type { ComparisonEntry } from "../lib/weather-comparison";
import styles from "./weather-ui.module.css";

export type WeatherComparisonScreenProps = {
  comparisonCount: number;
  comparisonLimit: number;
  entries: readonly ComparisonEntry[];
  onQueryChange: (query: string) => void;
  onRemoveLocation: (location: Location) => void;
  onRetryLocation: (location: Location) => void;
